const CACHE_NAME = 'MultitoolPro';
const urlsToCache = [
    './', 
    './index.html', 
    './manifest.json',
    // ২. নিচে Tailwind এর পুরনো লিংক সরিয়ে  নতুন গিটহাব লিংক বসানো হয়েছে
    'https://cdn.jsdelivr.net/gh/multitoolpro/multitoolpro.github.io@main/tailwind.js',
    ...
    'https://cdn.jsdelivr.net/gh/multitoolpro/multitoolpro.github.io/Bornomala-Regular.ttf',
    'https://cdn.jsdelivr.net/gh/multitoolpro/multitoolpro.github.io/SUTONNYMJ.TTF'
];
